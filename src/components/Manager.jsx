...
const Manager = () => {
  ...
  return (
    <>
      ...
      <div className="p-3 pt-3 md:mycontainer min-h-[88.2vh]">
        ...
        <div className="text-black flex flex-col p-4 gap-8 items-center">
          ...
          <div className="flex flex-col md:flex-row w-full justify-between gap-8">
            <input value={form.username} onChange={handleChange} className="rounded-full border border-green-500 w-full p-4 py-1" type="text" name="username" id="usernaem" placeholder="Enter Username" />
            <div className="relative">
              ...
              <span className="absolute right-[2px] top-[4px] cursor-pointer" onClick={showPassword}>
                <img ref={ref} className="p-1" width={25} src="/icons/open_eye.png" alt="" /></span>
            </div>
          </div>
          <button onClick={savePassword} className="flex justify-center items-center gap-2 bg-green-400 hover:bg-green-300 rounded-full px-8 py-2 w-fit border border-green-700 font-semibold">
            <lord-icon
